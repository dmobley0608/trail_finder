...
import { useGetUserQuery, useLazyLogoutQuery } from '../../../redux/backendApi'
                ...
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between ">
                            <div className="h-10 sm:hidden overflow-hidden">
                                {/* Mobile menu button*/}
                                <Disclosure.Button className="relative inline-flex max-h-full items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
